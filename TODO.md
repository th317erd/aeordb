      ...
      - [ ] P3c-2b: implement bounded capture, pressure/exhaustion latching, durable checkpoints, resume, and final full-reconciliation authority.
        ...
        - [ ] P3c-2b3: stream the base clone into the initialized destination, replay retained capture, and require an exact final-freeze authority/SystemFamily diff whenever capture is incomplete.
          ...
          - [ ] P3c-2b3d: acquire the explicit final write freeze and require an exact authority, retained-root, and SystemFamily reconciliation before allowing destination verification; incomplete capture can only increase this requirement.
            ...
            - [ ] P3c-2b3d2: compute a bounded strict Merkle diff between the last reconciled v3 source root and the frozen final root, then reuse the existing subtree translation, directory/B-tree planning, immutable batch, and successor authority paths without collecting the whole namespace. (active)
              ...
              - [ ] Run affected, architecture, full-workspace, real-file, and native-platform qualification gates and record durable evidence.
            - [ ] P3c-2b3d3: reconcile the complete frozen retained-root and SystemFamily inventory, stream every final root mapping, and let only the live freeze proof authorize the monotonic AMPR final-freeze completion/watermark.
