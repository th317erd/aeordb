...
impl QueryNode {
  fn to_json(&self) -> serde_json::Value {
    match self {
      QueryNode::Field { field, op, value, value2 } => {
...
impl QueryBuilder {
  ...
  pub fn field(self, name: impl Into<String>) -> FieldQueryBuilder {
    FieldQueryBuilder { parent: self, field_name: name.into() }
  }
  ...
  pub fn sort(mut self, field: impl Into<String>, direction: SortDirection) -> Self {
    self.sort_fields.push(SortField { field: field.into(), direction });
    self
  }
...
impl FieldQueryBuilder {
  ...
  pub fn between(self, min: &[u8], max: &[u8]) -> QueryBuilder {
    self.finish("between", serde_json::json!(base64_encode(min)), Some(serde_json::json!(base64_encode(max))))
  }

  /// Between (inclusive) on u64 values.
  pub fn between_u64(self, min: u64, max: u64) -> QueryBuilder {
    self.finish("between", serde_json::json!(min), Some(serde_json::json!(max)))
  }
  ...
  pub fn similar(self, text: &str, threshold: f64) -> QueryBuilder {
    self.finish("similar", serde_json::json!({ "text": text, "threshold": threshold }), None)
  }
  ...
  fn finish(self, op: &str, value: serde_json::Value, value2: Option<serde_json::Value>) -> QueryBuilder {
    self.parent.push_node(QueryNode::Field { field: self.field_name, op: op.to_string(), value, value2 })
  }
}
...
mod tests {
  ...
  fn test_single_eq_str() {
    let json = QueryBuilder::new("/users").field("name").eq_str("Wyatt").to_json();
    assert_eq!(json["path"], "/users");
  ...
  fn test_single_eq_u64() {
    let json = QueryBuilder::new("/users").field("age").eq_u64(30).to_json();
  ...
  fn test_single_eq_i64() {
    let json = QueryBuilder::new("/data").field("offset").eq_i64(-42).to_json();
  ...
  fn test_single_eq_f64() {
    ...
    let value = 3.14_f64;
    let json = QueryBuilder::new("/data").field("score").eq_f64(value).to_json();
    assert_eq!(json["where"]["value"], value);
  }

  #[test]
  fn test_single_eq_bool() {
    let json = QueryBuilder::new("/users").field("active").eq_bool(true).to_json();
    assert_eq!(json["where"]["value"], true);
  }

  #[test]
  fn test_gt_u64() {
    let json = QueryBuilder::new("/users").field("age").gt_u64(21).to_json();
  ...
  #[test]
  fn test_gt_str() {
    let json = QueryBuilder::new("/users").field("name").gt_str("M").to_json();
    assert_eq!(json["where"]["op"], "gt");
  ...
  #[test]
  fn test_gt_f64() {
    let json = QueryBuilder::new("/data").field("temperature").gt_f64(98.6).to_json();
    assert_eq!(json["where"]["op"], "gt");
  ...
  #[test]
  fn test_lt_u64() {
    let json = QueryBuilder::new("/users").field("age").lt_u64(65).to_json();
  ...
  #[test]
  fn test_lt_str() {
    let json = QueryBuilder::new("/data").field("label").lt_str("Z").to_json();
    assert_eq!(json["where"]["op"], "lt");
  ...
  #[test]
  fn test_lt_f64() {
    let json = QueryBuilder::new("/data").field("weight").lt_f64(100.5).to_json();
    assert_eq!(json["where"]["op"], "lt");
  ...
  #[test]
  fn test_between_u64() {
    let json = QueryBuilder::new("/users").field("age").between_u64(18, 65).to_json();
  ...
  #[test]
  fn test_between_str() {
    let json = QueryBuilder::new("/data").field("name").between_str("A", "M").to_json();
    assert_eq!(json["where"]["op"], "between");
  ...
  #[test]
  fn test_in_u64() {
    let json = QueryBuilder::new("/users").field("role_id").in_u64(&[1, 2, 3]).to_json();
  ...
  #[test]
  fn test_in_str() {
    let json = QueryBuilder::new("/users").field("status").in_str(&["active", "pending"]).to_json();
    assert_eq!(json["where"]["op"], "in");
    assert_eq!(json["where"]["value"], serde_json::json!(["active", "pending"]));
  }

  #[test]
  fn test_contains() {
    let json = QueryBuilder::new("/users").field("name").contains("Wyatt").to_json();
  ...
  #[test]
  fn test_similar() {
    let json = QueryBuilder::new("/users").field("name").similar("Wyat", 0.8).to_json();
  ...
  #[test]
  fn test_phonetic() {
    let json = QueryBuilder::new("/users").field("name").phonetic("Smith").to_json();
  ...
  #[test]
  fn test_fuzzy() {
    let json = QueryBuilder::new("/users").field("name").fuzzy("Wyat").to_json();
  ...
  #[test]
  fn test_match_query() {
    let json = QueryBuilder::new("/docs").field("body").match_query("rust programming").to_json();
  ...
  fn test_eq_raw_bytes() {
    let json = QueryBuilder::new("/data").field("hash").eq(&[0xDE, 0xAD, 0xBE, 0xEF]).to_json();
    assert_eq!(json["where"]["op"], "eq");
  ...
  fn test_multiple_conditions_implicit_and() {
    let json = QueryBuilder::new("/users").field("name").contains("Wyatt").field("age").gt_u64(21).to_json();
  ...
  fn test_explicit_and() {
    let json = QueryBuilder::new("/users").and(|q| q.field("name").contains("Wyatt").field("age").gt_u64(21)).to_json();
  ...
  #[test]
  fn test_explicit_or() {
    let json = QueryBuilder::new("/users").or(|q| q.field("role").eq_str("admin").field("role").eq_str("superadmin")).to_json();
  ...
  #[test]
  fn test_not() {
    let json = QueryBuilder::new("/users").not(|q| q.field("banned").eq_bool(true)).to_json();
  ...
  fn test_nested_boolean_logic() {
    let json = QueryBuilder::new("/users")
      .and(|q| q.field("active").eq_bool(true).or(|q2| q2.field("role").eq_str("admin").field("role").eq_str("moderator")))
      .to_json();
  ...
  #[test]
  fn test_limit() {
    let json = QueryBuilder::new("/users").field("active").eq_bool(true).limit(25).to_json();
    assert_eq!(json["limit"], 25);
  }

  #[test]
  fn test_offset() {
    let json = QueryBuilder::new("/users").field("active").eq_bool(true).offset(50).to_json();
    assert_eq!(json["offset"], 50);
  }

  #[test]
  fn test_sort_single() {
    let json = QueryBuilder::new("/users").sort("name", SortDirection::Asc).to_json();
  ...
  fn test_sort_multiple() {
    let json = QueryBuilder::new("/users").sort("last_name", SortDirection::Asc).sort("first_name", SortDirection::Desc).to_json();
    let sort = json["order_by"].as_array().unwrap();
  ...
  fn test_execute_native_error() {
    let result = QueryBuilder::new("/users").field("name").eq_str("test").execute();
    assert!(result.is_err());
    match result.unwrap_err() {
      PluginError::ExecutionFailed(message) => {
        assert!(message.contains("WASM context"), "unexpected error: {}", message);
      }
  ...
  fn test_aggregate_sum() {
    let json = AggregateBuilder::new("/orders").sum("total").to_json();
  ...
  fn test_aggregate_avg() {
    let json = AggregateBuilder::new("/orders").avg("price").to_json();
  ...
  fn test_aggregate_min_max() {
    let json = AggregateBuilder::new("/data").min_val("temperature").max_val("temperature").to_json();
  ...
  fn test_aggregate_group_by() {
    let json = AggregateBuilder::new("/orders").count().sum("total").group_by("status").to_json();
    assert_eq!(json["aggregate"]["count"], true);
  ...
  fn test_aggregate_limit() {
    let json = AggregateBuilder::new("/orders").count().group_by("category").limit(5).to_json();
    assert_eq!(json["limit"], 5);
  }

  #[test]
  fn test_aggregate_with_filter() {
    let json = AggregateBuilder::new("/orders").count().filter(|q| q.field("status").eq_str("completed")).to_json();
  ...
  fn test_query_builder_debug() {
    let builder = QueryBuilder::new("/users").field("name").eq_str("test").limit(10);
  ...
  fn test_empty_and_closure() {
    ...
    let json = QueryBuilder::new("/users").and(|q| q).field("name").eq_str("test").to_json();
  ...
  fn test_empty_or_closure() {
    let json = QueryBuilder::new("/users").or(|q| q).field("name").eq_str("test").to_json();
    assert_eq!(json["where"]["field"], "name");
  }
  ...
  fn test_not_with_empty_closure() {
    ...
    let json = QueryBuilder::new("/users").not(|q| q).to_json();
    assert_eq!(json["where"], serde_json::json!({}));
  }

  #[test]
  fn test_in_empty_values() {
    let json = QueryBuilder::new("/data").field("tags").in_str(&[]).to_json();
    assert_eq!(json["where"]["op"], "in");
  ...
  fn test_between_raw_bytes() {
    let json = QueryBuilder::new("/data").field("key").between(&[0x00], &[0xFF]).to_json();
    assert_eq!(json["where"]["op"], "between");
  ...
  fn test_gt_raw_bytes() {
    let json = QueryBuilder::new("/data").field("key").gt(&[0xAB]).to_json();
    assert_eq!(json["where"]["op"], "gt");
  }

  #[test]
  fn test_lt_raw_bytes() {
    let json = QueryBuilder::new("/data").field("key").lt(&[0xCD]).to_json();
    assert_eq!(json["where"]["op"], "lt");
  }

  #[test]
  fn test_in_raw_bytes() {
    let json = QueryBuilder::new("/data").field("hash").in_values(&[&[0x01], &[0x02]]).to_json();
    assert_eq!(json["where"]["op"], "in");
  ...
  fn test_path_with_special_characters() {
    let json = QueryBuilder::new("/data/my files/2026").field("name").eq_str("test").to_json();
