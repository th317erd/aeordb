...
async fn test_load_cors_config_from_engine() {
    ...
    ops.store_file(&ctx, "/.config/cors.json", config_json.as_bytes(), Some("application/json"))
        .unwrap();
...
async fn test_load_cors_config_invalid_json() {
    ...
    ops.store_file(&ctx, "/.config/cors.json", b"not valid json", Some("application/json"))
        .unwrap();
