...
async fn test_history_file_added() {
  ...
  let request =
    Request::builder().method("GET").uri("/versions/history/readme.txt").header("authorization", &auth).body(Body::empty()).unwrap();
...
async fn test_history_file_modified() {
  ...
  let app = rebuild_app(&jwt_manager, &engine);
  let request =
    Request::builder().method("GET").uri("/versions/history/data.txt").header("authorization", &auth).body(Body::empty()).unwrap();
...
async fn test_history_file_unchanged() {
  ...
  let app = rebuild_app(&jwt_manager, &engine);
  let request =
    Request::builder().method("GET").uri("/versions/history/stable.txt").header("authorization", &auth).body(Body::empty()).unwrap();
...
async fn test_history_file_deleted() {
  ...
  let app = rebuild_app(&jwt_manager, &engine);
  let request =
    Request::builder().method("GET").uri("/versions/history/temp.txt").header("authorization", &auth).body(Body::empty()).unwrap();
...
async fn test_history_full_lifecycle() {
  ...
  let app = rebuild_app(&jwt_manager, &engine);
  let request =
    Request::builder().method("GET").uri("/versions/history/lifecycle.txt").header("authorization", &auth).body(Body::empty()).unwrap();
...
async fn test_history_ordering_newest_first() {
  ...
  let app = rebuild_app(&jwt_manager, &engine);
  let request =
    Request::builder().method("GET").uri("/versions/history/ordered.txt").header("authorization", &auth).body(Body::empty()).unwrap();
...
async fn test_history_never_existed() {
  ...
  let app = rebuild_app(&jwt_manager, &engine);
  let request =
    Request::builder().method("GET").uri("/versions/history/nonexistent.txt").header("authorization", &auth).body(Body::empty()).unwrap();
...
async fn test_history_includes_metadata() {
  ...
  let app = rebuild_app(&jwt_manager, &engine);
  let request =
    Request::builder().method("GET").uri("/versions/history/meta.json").header("authorization", &auth).body(Body::empty()).unwrap();
...
async fn test_history_no_snapshots() {
  ...
  let app = rebuild_app(&jwt_manager, &engine);
  let request =
    Request::builder().method("GET").uri("/versions/history/lonely.txt").header("authorization", &auth).body(Body::empty()).unwrap();
...
async fn test_history_re_added_after_delete() {
  ...
  let app = rebuild_app(&jwt_manager, &engine);
  let request =
    Request::builder().method("GET").uri("/versions/history/phoenix.txt").header("authorization", &auth).body(Body::empty()).unwrap();
