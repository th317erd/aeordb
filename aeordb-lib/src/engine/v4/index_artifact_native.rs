...
use super::index_artifact_cursor::{
  ...
  ArtifactPageCursorRootV1, ArtifactPageNeighborModeV1, ArtifactPageSeekV1, LoadedArtifactPageCursorV1, RetainedArtifactBytesV1,
  load_artifact_page_cursor_v1,
};
use super::index_coverage_registry::{
  field_definition_fingerprint, field_dependency_fingerprint, scope_definition_fingerprint, scope_dependency_fingerprint,
};
use super::index_manifest::IndexManifestBodyV1;
use super::index_page::{OrderedIndexRoleV1, decode_artifact_directory, decode_ordered_page};
...
fn load_selected_directory_closure(
  ...
  match (&selected.details, role) {
    ...
    (IndexManifestBodyV1::FieldIndex(field_body), OrderedIndexRoleV1::Posting | OrderedIndexRoleV1::IndexDocumentState) => {
      ...
      validate_selected_fingerprints(selected_generation, &definition_fingerprint, &dependency_fingerprint)?;
      let (root_key, live_count, tombstone_count, page_count, logical_bytes, first_page_id, last_page_id) =
