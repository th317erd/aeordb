...
pub fn build_share_notification(sharer_name: &str, paths: &[String], permissions: &str, portal_url: &str) -> (String, String, String) {
...
mod tests {
  ...
  fn test_html_escaping() {
    ...
    let (_, html, _) = build_share_notification("Eve <evil>", &paths, "crudlify", "https://example.com?a=1&b=2");
