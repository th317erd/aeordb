...
pub mod error_codes {
  ...
  pub const INVALID_ROOT_HASH: &str = "INVALID_ROOT_HASH";
  pub const INVALID_ROOT_SELECTOR: &str = "INVALID_ROOT_SELECTOR";
  pub const INVALID_PAGINATION: &str = "INVALID_PAGINATION";
  pub const INVALID_POSITION_CURSOR: &str = "INVALID_POSITION_CURSOR";
  pub const POSITION_ROOT_MISMATCH: &str = "POSITION_ROOT_MISMATCH";
  pub const POSITION_ORDER_MISMATCH: &str = "POSITION_ORDER_MISMATCH";
  pub const ROOT_EXPIRED: &str = "ROOT_EXPIRED";
  pub const INVALID_NAMESPACE_ROOT: &str = "INVALID_NAMESPACE_ROOT";
  pub const HISTORICAL_VIEW_UNAVAILABLE: &str = "HISTORICAL_VIEW_UNAVAILABLE";
