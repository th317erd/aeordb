...
pub const INDEX_RUNTIME_COVERAGE_ENTRIES: &str = "aeordb_index_runtime_coverage_entries";
pub const INDEX_RUNTIME_COVERAGE_RETAINED_BYTES: &str = "aeordb_index_runtime_coverage_retained_bytes";
pub const INDEX_RUNTIME_COVERAGE_REFRESH_ATTEMPTS: &str = "aeordb_index_runtime_coverage_refresh_attempts";
pub const INDEX_RUNTIME_COVERAGE_REFRESH_SUCCESSES: &str = "aeordb_index_runtime_coverage_refresh_successes";
pub const INDEX_RUNTIME_COVERAGE_REFRESH_PENDING: &str = "aeordb_index_runtime_coverage_refresh_pending";
pub const INDEX_RUNTIME_COVERAGE_REFRESH_FAILURES: &str = "aeordb_index_runtime_coverage_refresh_failures";
pub const INDEX_RUNTIME_COVERAGE_SELECTED_GENERATIONS: &str = "aeordb_index_runtime_coverage_selected_generations";
pub const INDEX_RUNTIME_COVERAGE_UNAVAILABLE_GENERATIONS: &str = "aeordb_index_runtime_coverage_unavailable_generations";
pub const INDEX_RUNTIME_COVERAGE_USABLE_NVT_GENERATIONS: &str = "aeordb_index_runtime_coverage_usable_nvt_generations";
pub const INDEX_RUNTIME_SCOPE_CACHE_ENTRIES: &str = "aeordb_index_runtime_scope_cache_entries";
pub const INDEX_RUNTIME_SCOPE_CACHE_RESIDENT_BYTES: &str = "aeordb_index_runtime_scope_cache_resident_bytes";
pub const INDEX_RUNTIME_SCOPE_CACHE_PINNED_ENTRIES: &str = "aeordb_index_runtime_scope_cache_pinned_entries";
pub const INDEX_RUNTIME_SCOPE_CACHE_HITS: &str = "aeordb_index_runtime_scope_cache_hits";
pub const INDEX_RUNTIME_SCOPE_CACHE_MISSES: &str = "aeordb_index_runtime_scope_cache_misses";
