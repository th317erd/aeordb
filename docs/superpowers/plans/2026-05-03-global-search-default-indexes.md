...
> **Partially incorporated on 2026-08-03.** Do not execute this file's NVT,
> global-fan-out, or index-persistence sequence as v4 work. The current v4
> query/index/migration contract is the
